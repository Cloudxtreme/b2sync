...
public:
    ...
    B2APIMessage<B2Bucket> createBucket(const std::string &bucketName, const B2BucketType &bucketType) const;
    B2APIMessage<void> deleteBucket(const B2Bucket bucket) const;
